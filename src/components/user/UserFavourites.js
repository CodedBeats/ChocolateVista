        ...
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(
                    "http://localhost/server/favourite/getUserFavourites.php",
                    {
                        method: "POST",
                        headers: {
                ...
                if (jsonData.success) {
                    ...
                    const fetchedChocolates = jsonData.chocolatesData.map(
                        (chocData) => {
                            const [chocID, name, imgUrl, rating, numRatings] =
                                chocData;
        ...
        <div className="user-favourites">
            ...
            <div className="favourites-cards-container">
                {!noChocolatesDisplay ? (
                    ...
                    <div>You currently have no favourites</div>
                )}
            </div>
        </div>
    );
