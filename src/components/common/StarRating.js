...
const StarRating = (props) => {
    ...
    const handleClick = (value) => {
        ...
        console.log(
            `numRatigs:${props.numRatings}, rating:${props.rating}, ratingAvg:${ratingAvg}, newRating:${newRating}`
        );
        ...
        fetch("http://localhost/server/chocolate/updateRating.php", {
            ...
            .then((data) => {
                ...
                setNumRatingsInstance(
                    parseInt(numRatingsInstance) + parseInt(1)
                );
                ...
                <>
                    {[1, 2, 3, 4, 5].map((value) => (
                        ...
                        >
                            <FontAwesomeIcon
                                icon={
                                    value <= ratingAvg ? solidStar : regularStar
                                }
                                className={`star-icon ${
